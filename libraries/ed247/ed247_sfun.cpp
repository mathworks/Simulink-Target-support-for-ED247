...
/*
	if (*blockType == SEND){
		ed247sfcn::Send *obj = (ed247sfcn::Send*) ssGetPWork(S)[1]; 
		obj->start();
		
	} else if (*blockType == RECEIVE){
		ed247sfcn::Receive *obj = (ed247sfcn::Receive*) ssGetPWork(S)[1]; 
		obj->start();
        
	} else {
		ed247sfcn::Configure *obj = (ed247sfcn::Configure*) ssGetPWork(S)[1]; 
		obj->start();
	}
*/
}
